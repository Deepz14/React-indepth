        ...
        <div className="max-w-[800] min-h-[800] mt-[20] mr-auto ml-[auto] p-[20]">
            <div className="flex justify-between flex-wrap">
                <div>
                    ...
                    <h5 className="font-semibold text-slate-400 py-[3]">{resInfo?.cuisines.join(',')}</h5>
                    <h5 className="font-semibold text-slate-400 py-[3]">{resInfo?.areaName}, {resInfo?.sla?.lastMileTravelString}</h5>
                </div>
                <div className="ratings-container border border-solid border-gray-200 rounded-md">
                    ...
                    border-l-transparent border-b-gray-300 mt-[20] mx-[15] pb-[8] flex items-center">
                        ...
                        10.8618L4.95521 8.99028C4.60833 8.70388 4.78653 8.14085 5.23502 8.10619L8.23448 7.87442C8.29403 
                        7.86982 8.34612 7.83261 8.36979 7.77777L9.54092 5.06385C9.71462 4.66132 10.2854 4.66132 10.4591 
                        5.06385L11.6302 7.77777C11.6539 7.83261 11.706 7.86982 11.7655 7.87442L14.765 8.10619C15.2135 8.14085 
                        15.3917 8.70388 15.0448 8.99028L12.7781 10.8618C12.7303 10.9012 12.7095 10.9644 12.7243 11.0245L13.4225 
                    ...
                    <h6 className="mt-[10] mx-[15] pb-[8] font-semibold text-slate-400">{resInfo?.totalRatingsString}</h6>
                </div>
            </div>
            <hr className="my-[12] border border-dotted border-t-transparent border-r-transparent 
                    border-l-transparent border-b-gray-700" />
            <div className="delivery-info-time my-[16]">
                <h5 className="font-bold flex items-center flex-wrap">
                    <svg class="RestaurantTimeCost_icon__8UdT4" width="18" height="18" viewBox="0 0 18 18" 
                    ...
                    <span className="mx-[15] font-bold">&#8377; {resInfo?.costForTwo / 100}</span>
                </h5>
            </div>
            <div className="res-info-recomm-container mt-[20]">
                {
                    recomntdInfo.length > 0 ? 
                    <div className="res-info-recomm-list">
                        <h1 className="font-bold mb-[20] text-[22px]">Recommented ({recomntdInfo?.length})</h1>
